...
public class PlacesFragment extends ParentFragment
{
      ...
      Bundle savedInstanceState)
  {
    ...
    EditText selected = (EditText) view.findViewById(R.id.selectedPlace);
    try
    {
   ...
   * getMenuInflater().inflate(R.layout.activity_places, menu); return true; }
   */
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
      ...
      snippetView.setOnClickListener(new View.OnClickListener()
      {
        ...
        public void onClick(View v)
        {
          ...
          resultIntent.putExtra("LOCATION_DATA", curPlace.getName()
            + ", " + curPlace.getAddress());
  ...
  private class LongOperation extends AsyncTask<String, Void, String>
  {
    ...
    protected String doInBackground(String... params)
    {
      try
      {
        ...
        /*
         * int rrIndex = 0; do { query.setRadius(radiusRanges[rrIndex++]); //inc
         * rrIndex as long as places results < 20
         * 
         * System.out.println("Query: " + query.toString()); PlacesResult result
         * = googlePlaces.getPlaces(query);
         * 
         * placeList = (ArrayList<Place>) result.getPlaces();
         * 
         * for (int i = 0; i < placeList.size(); i++) {
