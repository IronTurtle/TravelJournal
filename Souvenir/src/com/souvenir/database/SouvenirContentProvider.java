...
public class SouvenirContentProvider extends ContentProvider {
	...
	public boolean onCreate() {
		this.database = new SouvenirDbHelper(getContext(), SouvenirDbHelper.DATABASE_NAME, 
				null, SouvenirDbHelper.DATABASE_VERSION);
		return false;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
		...
		case APP_NAME:
			...
			queryBuilder.appendWhere(SouvenirContract.SouvenirNote.COLUMN_NAME_NOTE_GUID + 
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case APP_ID:
			...
			id = sqlDB.insert(SouvenirContract.SouvenirNote.TABLE_NAME_NOTE, null, values);
			break;
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
	    ...
	    case APP_ID:
	    	...
	    	if(!TextUtils.isEmpty(selection)) {
		    	rowsUpdated = sqlDB.update(SouvenirContract.SouvenirNote.TABLE_NAME_NOTE, values,
		    			SouvenirContract.SouvenirNote.COLUMN_NAME_NOTE_GUID + "=" + id + " AND " + selection, null);
	    	} else {
		    	rowsUpdated = sqlDB.update(SouvenirContract.SouvenirNote.TABLE_NAME_NOTE, values,
		    			SouvenirContract.SouvenirNote.COLUMN_NAME_NOTE_GUID + "=" + id, null);
	    	}
