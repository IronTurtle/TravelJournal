...
public class SnippetAdapter extends ArrayAdapter<NoteMetadata>
{
  ...
  public View getView(int position, View convertView, ViewGroup parent)
  {
     ...
     * BitmapFactory.decodeStream((InputStream)new URL(imageUrl).getContent());
  ...
  private class ThumbDler extends AsyncTask<Object, String, Bitmap>
  {
    ...
    protected Bitmap doInBackground(Object... param)
    {
       ...
       * mEvernoteSession.getAuthToken())); nameValuePairs.add(new
       * BasicNameValuePair("size", "75")); httpPost.setEntity(new
       * UrlEncodedFormEntity(nameValuePairs));
       * 
       * //HttpGet get = new
       * HttpGet("https://sandbox.evernote.com/shard/s1/thm/res/" +
       * mEvernoteNote.getGuid() +"?auth="+mEvernoteSession.getAuthToken());
